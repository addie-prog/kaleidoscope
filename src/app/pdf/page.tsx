...
export default function ReportPage() {
    ...
    return (
        <div>
            ...
            <div className='mx-auto max-w-4xl px-4 pt-6 sm:pt-8 lg:pt-12 justify-right' >

        {/* <div className="block float-right">
                    <button className="w-fit cursor-pointer flex items-center gap-[5px] text-white px-5 sm:py-2 py-2 rounded-lg bg-[#3B82F6] text-center" onClick={reactToPrintFn}>
