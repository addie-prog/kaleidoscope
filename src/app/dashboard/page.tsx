 ...
 {/* Sub-tabs */}
              ...
              {currentSubTabs?.map((subTab: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="sm:text-base text-sm font-medium">{subTab.percentage}%</span>
                  </button>
                );
              })}
                        ...
                        >
                                  ...
                                  setActiveCards((prev) => ({
                                    ...
                                    [categoryKey]: prev[categoryKey]?.map((card1: any) =>
                                      card1.id == card.id
                                        ? {
                                          ...card1,
                                          cardChecked:card?.cardChecked ? false : true,
                                        }
                                        : card1
                                    )
                                  }))
                          ...
                          >
                            ...
                            <div className="w-auto flex items-center border-t border-b border-[#E5E5E5] px-5 overflow-x-auto no-scrollbar">
                              <button
                                ...
                                className={`relative flex-1 sm:flex-none sm:mr-4 flex py-[12px] justify-center items-center gap-1.5 transition-colors flex-shrink-0 min-w-fit bg-white border-0  ${card?.activeCardTab === "action"
                                   ? "border-b-2"
                                   : "border-b-2 border-transparent"
                                 } `}
                                // className={`flex items-center justify-center gap-1 sm:px-4 py-3 transition-colors ${card?.activeCardTab === "action"
                                //   ? "border-b-2"
                                //   : "border-b-2 border-transparent"
                                //   }`}
                              ...
                              <button
                                ...
                                className={`relative flex-1 sm:flex-none flex sm:mx-4 ml-4 py-[12px] justify-center items-center gap-1.5 transition-colors flex-shrink-0 min-w-fit bg-white border-0  ${card?.activeCardTab === "context"
                                   ? "border-b-2"
                                   : "border-b-2 border-transparent"
                                 } `}
                          ...
                          //         }  `}
                              ...
                              <button
                                ...
                                className={`relative flex-1 sm:flex-none flex sm:mx-4 ml-4 py-[12px] justify-center items-center gap-1.5 transition-colors flex-shrink-0 min-w-fit bg-white border-0  ${card?.activeCardTab === "diligence"
                                   ? "border-b-2"
                                   : "border-b-2 border-transparent"
                                 } `}
                                // className={`flex items-center justify-center gap-1 px-4 py-3 transition-colors ${card?.activeCardTab === "diligence" ? "border-b-2"
                                //   : "border-b-2 border-transparent"
                                //   }`}
                                style={{
       ...
       {/* Sticky Action Buttons */}
         ...
         <div className="fixed z-90 w-full left-0 right-0 bottom-0 bg-white border-t border-[#E5E5E5] p-2 sm:p-4 shadow-[0_-4px_12px_rgba(0,0,0,0.08)]">
          ...
          {/* <div className="fixed z-90 w-full flex justify-between bottom-0 bg-white border-t border-[#E5E5E5] p-4 space-y-2 shadow-[0_-10px_12px_rgba(0,0,0,0.08)]">
            <div className="flex gap-2.5 mb-0">
              <button onClick={() => redirect(`/calculator?project=${project}`)} className="flex-1 flex items-center justify-center gap-1  px-3 py-2 border border-[#E5E7EB] bg-[#F9FAFB] rounded-xl hover:bg-gray-100 transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <button onClick={saveProgressModal.openModal} className="flex-1 flex items-center justify-center gap-1 px-3 py-2 border border-[#E5E7EB] bg-[#F9FAFB] rounded-xl hover:bg-gray-100 transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
            ...
            <button onClick={downloadReportModal.openModal} className="w-auto flex items-center justify-center gap-1  px-3 py-2 bg-[#3B82F6] rounded-lg hover:bg-[#2563EB] transition-colors">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <button onClick={downloadCSVModal.openModal} className="w-auto flex items-center justify-center gap-1  px-3 py-2 bg-[#3B82F6] rounded-lg hover:bg-[#2563EB] transition-colors">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
